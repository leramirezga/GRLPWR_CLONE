...
enum FeaturesEnum: string
{
    ...
    case SEE_ACHIEVEMENTS_PROGRESS = 'SEE_ACHIEVEMENTS_PROGRESS';
    case SEE_REVIEWS = 'SEE_REVIEWS';
    case SEE_CHECK_ATTENDEES = 'SEE_CHECK_ATTENDEES';
    case SEE_PETTY_CASH_BUTTON  = 'SEE_PETTY_CASH_BUTTON';
    case SEE_ACCOUNTING_FLOW_BUTTON  = 'SEE_ACCOUNTING_FLOW_BUTTON';
    case SEE_PAYMENT_METHODS = 'SEE_PAYMENT_METHODS';
    case SEE_STATISTICS = 'SEE_STATISTICS';
    case SEE_PLAN_EXPIRATION = 'SEE_PLAN_EXPIRATION';
}